...
class EighteenGamingWrathOfOlympus(Slot):
    ...
    def setup(self):
        ...
        self.sb.find_elements(scatterStr)[adjustmentIndex].click()
        Sleep(self.sb)
        acceptStr = '//div[contains(@class,"confirm-btn")]'
        self.sb.find_elements(acceptStr)[adjustmentIndex].click()
