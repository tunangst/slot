...
class EighteenGamingKetchupVsMayo(Slot):
    ...
    def setup(self):
        ...
        self.sb.find_elements(scatterStr)[cloneIndex].click()
        Sleep(self.sb)
        confirmStr = 'div.confirm-btn'
        self.sb.find_elements(confirmStr)[cloneIndex].click()
